...
- [Configuration](/en/ops/config) — all `.env`
- [Development guide](/en/getting-started/workflow) — adding business modules
- [Startup init](/en/develop/init-data) — relation to migration & first-time seeds
