...
- [Development guide](/en/backend/development) — create a new module via the CLI
- [Init data](/en/backend/init-data) — how `init()` runs and reconciles
- [HR module](/en/backend/business/hr) — sample business module
