...
- 尝试请教认识的朋友或技术大佬
- 在FastSoyAdmin官方交流群里面提问，请尽量描述清楚问题，以便大家更好的帮助你，可以参考 [提问的智慧](https://github.com/tvvocold/How-To-Ask-Questions-The-Smart-Way)

## FastSoyAdmin 缓存方面的问题

**问题背景**

FastSoyAdmin 的项目配置默认是  `localStorage` , 初始化时对项目的主题涉及的数据进行持久化
...
> 完整代码指路 [FastSoyAdmin🔜](https://github.com/sleep1223/fast-soy-admin/blob/main/.npmrc)
...
> 完整代码指路 [FastSoyAdmin🔜](https://github.com/sleep1223/fast-soy-admin/blob/main/env-config.ts)
